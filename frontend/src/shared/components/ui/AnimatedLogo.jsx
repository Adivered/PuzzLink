...
/**
 * Animated Logo component following Single Responsibility Principle
 * Original design with GSAP hover animations and gradient text
 */
export const AnimatedLogo = ({ className = '' }) => {
  ...
  return (
    <Link 
      to="/"
      ref={logoRef}
      className={`text-3xl font-bold transition-colors duration-300 ${className}`}
    >

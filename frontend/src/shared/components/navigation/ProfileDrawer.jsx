...
/**
 * Profile Drawer component following Single Responsibility Principle
 * Original design with GSAP animations and proper theme integration
 */
export const ProfileDrawer = forwardRef(({ isOpen, onClose, user, onLogout }, ref) => {

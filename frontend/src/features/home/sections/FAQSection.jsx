...
/**
 * FAQ Section component following Single Responsibility Principle
 * Displays frequently asked questions with animations and theme integration
 */
export const FAQSection = ({ theme, sectionRef }) => (
  <section 
    id="faq" 
    ref={sectionRef} 

...
/**
 * Testimonials Section component following Single Responsibility Principle
 * Displays user testimonials with animations and theme integration
 */
export const TestimonialsSection = ({ theme, sectionRef }) => (
  <section 
    id="testimonials" 
    ref={sectionRef} 
